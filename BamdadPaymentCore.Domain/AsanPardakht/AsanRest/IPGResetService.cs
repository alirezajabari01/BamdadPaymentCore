...
namespace RestService
{
    public class IPGResetService : IIPGResetService
    {
        ...
        public async Task<VerifyVm> VerifyTrx(VerifyCommand verifyCommand, SelectPaymentDetailResult paymentDetail)
        {
            var client = CreateClient(paymentDetail);
        ...
        public async Task<SettleVm> SettleTrx(SettleCommand settleCommand, SelectPaymentDetailResult paymentDetail)
        {
            var client = CreateClient(paymentDetail);
        ...
        public async Task<PaymentResultVm> TranResult(int merchantConfigId, long localInvoiceId, SelectPaymentDetailResult paymentDetail)
        {
            var client = CreateClient(paymentDetail);
            PaymentResultVm paymentResultVm;
            try
